...
import SonGokuRobot.modules.sql.global_bans_sql as gban_sql
import SonGokuRobot.modules.sql.users_sql as user_sql
from SonGokuRobot import DEV_USERS, OWNER_ID, dispatcher
