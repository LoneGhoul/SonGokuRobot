...
def afk(update: Update, context: CallbackContext):
    ...
    try:
        update.effective_message.reply_text("{} ➤ Sayonara {} ! We hope to see you soon!".format(
            notice, fname))
    except BadRequest:
        pass
...
def no_longer_afk(update: Update, context: CallbackContext):
    ...
    if res:
        ...
        try:
            options = [
                'Yay! {} is back! Now gib party.', '{} is back to rock!', '{} welcome back.. no one missed you!!',
                '{} why you cam here? GET OUT!', '{} welcome back...Now pay 100$ or get banned.',
