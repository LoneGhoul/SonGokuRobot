...
from SonGokuRobot.__main__ import DATA_IMPORT
from telegram.ext import CommandHandler, run_async
import SonGokuRobot.modules.sql.notes_sql as sql
# from SonGokuRobot.modules.sql.locks_sql as locksql
import SonGokuRobot.modules.sql.rules_sql as rulessql
from SonGokuRobot.modules.connection import connected
# import SonGokuRobot.modules.sql.welcome_sql as welcsql
# from SonGokuRobot.modules.sql import warns_sql as warnssql
import SonGokuRobot.modules.sql.blacklist_sql as blacklistsql
from SonGokuRobot.modules.sql import disable_sql as disabledsql
from SonGokuRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from SonGokuRobot.modules.helper_funcs.chat_status import user_admin
# from SonGokuRobot.modules.sql import cust_filters_sql as filtersql
from SonGokuRobot.modules.helper_funcs.alternate import typing_action
...
def export_data(update, context):
    ...
    f = open("SonGokuRobot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SonGokuRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SonGokuRobot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("SonGokuRobot{}.backup".format(chat_id))  # Cleaning file
