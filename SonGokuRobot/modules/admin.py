...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if user_id == bot.id:
        message.reply_text(
            "Wha? Wait a sec.. How can I promote myself? Are you dumb (。_。)?")
        return
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    if user_member.status == 'creator':
        message.reply_text(
            "This person CREATED the chat, how would I demote them? Dummy 😑😑")
        return
    ...
    if user_id == bot.id:
        message.reply_text(
            "I can't demote myself! Get an admin to do it for me :P")
        return
...
def set_title(update: Update, context: CallbackContext):
    ...
    if not title:
        message.reply_text("Setting blank title doesn't do anything lol!")
        return
    ...
    try:
        ...
        message.reply_text(
            "I can't set custom title for admins that I didn't promote :P")
        return

    bot.sendMessage(
        chat.id,
        f"AWOOOOOOO! Sucessfully set title for <code>{user_member.user.first_name or user_id}</code> "
