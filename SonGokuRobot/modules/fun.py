...
# Please wait for @Goku_kunto push new updates in this module after some days (maybe months because I am lazy). 
# I will inform in @Goku_updates if I make changes (╹ڡ╹).
import SonGokuRobot.modules.fun_strings as fun_strings
import SonGokuRobot.modules.helper_funcs.fun_strings as fun
from SonGokuRobot import dispatcher
from SonGokuRobot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
