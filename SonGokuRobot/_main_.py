...
from SonGokuRobot.modules import ALL_MODULES
from SonGokuRobot.modules.helper_funcs.chat_status import is_user_admin
from SonGokuRobot.modules.helper_funcs.misc import paginate_modules
...
Use /help to know my abilities! [ㅤ](https://telegra.ph/file/87d60990536e122c42d53.mp4).
"""

HELP_STRINGS = """
[Son Goku](https://telegra.ph/file/87d60990536e122c42d53.mp4) at your service.
...
SONGOKU_IMG = "https://telegra.ph/file/315957d59f73202874e6a.mp4"
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [                         
                       InlineKeyboardButton(
                             text="Watch Anime!",
                             url="https://t.me/Anime_Channel_Official")
                    ],
                     [
                         InlineKeyboardButton(
                             text="Support Chat",
        ...
        update.effective_message.reply_text(
            "Hola! I am online to entertain you! \n<b>Son Goku is online since:</b> <code>{}</code>".format(uptime),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Son Goku is now online to rock 😎")
        except Unauthorized:
